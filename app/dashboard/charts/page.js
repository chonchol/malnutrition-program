...
export default function ChartsPage() {
    ...
    const patientMuacData = useMemo(() => {
        ...
        if (patientAssessments.length === 0) {
            setNirogError("No assessments found for this NIROG ID");
            return null;
        }
        setNirogError("");
                ...
                <div className="mx-auto max-w-7xl space-y-6 px-4 py-10">
                    <div className="space-y-6">
                        ...
                        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm mb-6">
                            <h2 className="text-xl font-bold text-slate-900 mb-4">Individual Patient MUAC Tracking</h2>
                                ...
                                <div>
                                    <div className="mb-4 p-4 bg-emerald-50 rounded-lg border border-emerald-200">
                                        <p className="text-sm text-emerald-900">
                                            <span className="font-semibold">Patient:</span> {patientMuacData[0]?.patientName} |
                                            <span className="font-semibold ml-3">NIROG ID:</span> {nirogId} |
                                            <span className="font-semibold ml-3">Age:</span> {patientMuacData[0]?.age} |
                                            <span className="font-semibold ml-3">Gender:</span> {patientMuacData[0]?.gender} |
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                                <h2 className="text-xl font-bold text-slate-900 mb-4">Gender Distribution</h2>
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                                <h2 className="text-xl font-bold text-slate-900 mb-4">Mental Health Risk Distribution</h2>
                                <div style={{ height: "350px", position: "relative" }}>
                                    <Pie
