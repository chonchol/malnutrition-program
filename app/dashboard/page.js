...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen px-4 py-10">
      <div className="mx-auto max-w-6xl space-y-6 lg:grid lg:grid-cols-[auto,1fr] lg:items-start lg:gap-6">
          ...
          <header className="glass flex items-center justify-between rounded-3xl px-4 py-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="hidden rounded-2xl bg-slate-900 px-3 py-2 text-xs font-semibold text-white shadow-lg shadow-slate-300/70 md:inline-flex dark:bg-emerald-600 dark:shadow-emerald-900/50"
              >
                Export Excel
              </button>
              <Link
                href="/patients/new"
                className="rounded-2xl border border-slate-200 px-3 py-2 text-xs font-semibold text-slate-800 dark:border-slate-700 dark:text-slate-100"
              >
                New assessment
              </Link>
              ...
              <div className="flex items-center gap-2 rounded-2xl bg-white/70 px-3 py-1.5 text-xs dark:bg-slate-900/60">
                ...
                <button
                  ...
                  className="ml-1 rounded-full border border-rose-200 px-2 py-1 text-[10px] font-semibold text-rose-600 hover:bg-rose-50 dark:border-rose-500/50 dark:text-rose-200 dark:hover:bg-rose-950/40"
                >
                  Logout
                </button>
              </div>
