        ...
        >
            ...
            <div className="border-t border-slate-200 p-4 dark:border-slate-700">
                {onLogout && (
                    <button
                        onClick={onLogout}
                        className={`flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-700 transition-colors hover:bg-red-50 dark:text-slate-200 dark:hover:bg-red-900/20 cursor-pointer ${collapsed ? "justify-center" : ""
                            }`}
